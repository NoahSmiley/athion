...
const AFTER: Cable[] = [
 ...
 {id:'C4',from:['SRV','nic'],to:['PP','rear',16],speed:'2.5G',a:'Proxmox host · RTL8126 5GbE (rear I/O)',b:'Patch panel · coupler 17 (rear)',len:'2 m · UniFi Etherlighting',why:'Verified live: the host NIC is a 5 GbE Realtek RTL8126 currently negotiated to 1000 Mb/s on the TP-Link. It lands on a keystone coupler in the back of slot 17, which is patched to switch port 17 (2.5 GbE PoE++), for a planned 2.5 GbE link; verify negotiation after cutover. The modeled route is about 1.1 m before slack; choose a 2 m UniFi Etherlighting cable. Jellyfin, NFS to the tank, MC and PZ servers, and every rsync deploy from the Mac all live behind this one cable.'},
 {id:'C5',from:['GPC','nic'],to:['PP','rear',17],speed:'2.5G',a:'Gaming PC · onboard Ethernet (2.5G assumed) (rear I/O)',b:'Patch panel · coupler 18 (rear)',len:'3 m · UniFi Etherlighting',why:'Coupler in slot 18, patched to switch port 18. Gaming PC to server copies and Jellyfin streams switch locally at 2.5 GbE without touching the router. The modeled side-channel run is about 1.5 m before slack. Choose 3 m to allow a service loop for the deep RM51; 2 m is an option for fixed installation without promising full slide-out reach.'},
 {id:'C6',from:['SPC','nic'],to:['PP','rear',18],speed:'2.5G',a:"Sam's PC · onboard Ethernet (2.5G assumed) (rear I/O)",b:'Patch panel · coupler 19 (rear)',len:'2 m · UniFi Etherlighting',why:'Coupler in slot 19, patched to switch port 19. The modeled route is about 1.4 m before slack; choose a 2 m UniFi Etherlighting cable. If the board is only 1 GbE it links at 1 GbE on the same port; no reason to burn a multi-gig port elsewhere.'},
