...
const AFTER: Cable[] = [
 ...PERIPHERALS,
 {id:'H1',from:['ENTRY',0],via:'AP',to:['PP','rear',19],speed:'2.5G',a:'U7 Pro · ceiling mount',b:'Patch panel · keystone 20 (rear)',len:'solid-core Cat6a',why:'The U7 Pro hangs on the ceiling outside the cabinet and is powered by PoE++ from switch port 20 through this single run. Permanent in-wall run. It enters through the LINIER top cable access, comes down the rear of the cabinet, and punches down on a UniFi Cat6A keystone that snaps into slot 20 from the back of the panel. Nothing on the front of the panel is ever cut; you only move patch cords.'},
 {id:'H2',from:['ENTRY',1],to:['PP','rear',8],speed:'1G',a:'Living room TV jack',b:'Patch panel · keystone 9 (rear)',len:'solid-core Cat6a',why:'Same structured-cabling rule: wall-plate keystone at one end, panel keystone at the other, tested once, never touched again. Slot 9 lands on switch port 9, a 1 GbE port.'},
 ...
 {id:'C2',from:['UCI','p',0],to:['UDM','wan'],speed:'1G',a:'UCI · front 2.5 GbE port',b:'UDM Pro · port 9 RJ45 WAN',len:'0.15 m Etherlighting',why:'The UCI port sits almost directly under the UDM Pro WAN jack, so this is the shortest cord in the rack. Port 9 is a 1 GbE WAN link shared by all Internet traffic. The ISP download and upload rates still need verification; they may impose a lower ceiling. Above 1 Gbps you move this to SFP+ port 10 with a multi-gig module.'},
 ...
 {id:'C4',from:['SRV','nic'],to:['PP','rear',16],speed:'2.5G',a:'Proxmox host · RTL8126 5GbE (rear I/O)',b:'Patch panel · coupler 17 (rear)',len:'1 m · rear channel',why:'Verified live: the host NIC is a 5 GbE Realtek RTL8126 currently negotiated to 1000 Mb/s on the TP-Link. It lands on a keystone coupler in the back of slot 17, which is patched to switch port 17 (2.5 GbE PoE++), for a planned 2.5 GbE link; verify negotiation after cutover. Jellyfin, NFS to the tank, MC and PZ servers, and every rsync deploy from the Mac all live behind this one cable.'},
 {id:'C5',from:['GPC','nic'],to:['PP','rear',17],speed:'2.5G',a:'Gaming PC · onboard Ethernet (2.5G assumed) (rear I/O)',b:'Patch panel · coupler 18 (rear)',len:'2 m · rear channel',why:'Coupler in slot 18, patched to switch port 18. Gaming PC to server copies and Jellyfin streams switch locally at 2.5 GbE without touching the router. Longest cord in the rack because the RM51 is at the bottom.'},
 {id:'C6',from:['SPC','nic'],to:['PP','rear',18],speed:'2.5G',a:"Sam's PC · onboard Ethernet (2.5G assumed) (rear I/O)",b:'Patch panel · coupler 19 (rear)',len:'1.5 m · rear channel',why:'Coupler in slot 19, patched to switch port 19. If the board is only 1 GbE it links at 1 GbE on the same port; no reason to burn a multi-gig port elsewhere.'},
 {id:'P1',multi:[[16,16]],speed:'2.5G',a:'Patch panel · slot 17 (server)',b:'USW Pro Max · port 17 (2.5 GbE PoE++)',len:'0.15 m Etherlighting',why:'Panel slot 17 to switch port 17. With every slot patched 1:1, the panel number IS the switch port number, so the port map and the wall labels never disagree.'},
 {id:'P2',multi:[[17,17]],speed:'2.5G',a:'Patch panel · slot 18 (gaming PC)',b:'USW Pro Max · port 18 (2.5 GbE PoE++)',len:'0.15 m Etherlighting',why:'Panel slot 18 to switch port 18.'},
 {id:'P3',multi:[[18,18]],speed:'2.5G',a:"Patch panel · slot 19 (Sam's PC)",b:'USW Pro Max · port 19 (2.5 GbE PoE++)',len:'0.15 m Etherlighting',why:'Panel slot 19 to switch port 19.'},
 {id:'P4',multi:[[19,19]],speed:'2.5G',a:'Patch panel · slot 20 (AP drop)',b:'USW Pro Max · port 20 (2.5 GbE PoE++)',len:'0.15 m Etherlighting',why:'The U7 Pro access point has a 2.5 GbE uplink and is PoE powered through this port. This replaces the TP-Link radio.'},
 {id:'P21-24',multi:[[20,20],[21,21],[22,22],[23,23]],speed:'OFF',a:'Patch panel · slots 21 to 24',b:'USW Pro Max · ports 21 to 24 (2.5 GbE PoE++)',len:'4 x 0.15 m Etherlighting',why:'Patched now, no link yet. These are the remaining multi-gig PoE++ ports, reserved for more APs, cameras, or a 2.5 GbE dock. Etherlighting stays dark until something links.'},
 ...
 {id:'P10',multi:[[9,9]],speed:'1G',a:'Patch panel · slot 10 (office)',b:'USW Pro Max · port 10 (1 GbE PoE++)',len:'0.15 m Etherlighting',why:'Reserved for a wired Mac dock at the desk. Runs at gigabit until a dock with a 2.5 GbE NIC shows up, then move it to slot 21.'},
