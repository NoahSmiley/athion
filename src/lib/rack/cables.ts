...
const AFTER: Cable[] = [
 ...PERIPHERALS,
 {id:'H1',from:['ENTRY',0],via:'AP',to:['PP','rear',19],speed:'2.5G',a:'U7 Pro Max · ceiling mount',b:'Patch panel · Cat6 coupler 20 (rear)',len:'Ethernet · measure route',why:'The U7 Pro Max hangs on the ceiling outside the cabinet and is powered by PoE+ from switch port 20 through this single run. Permanent in-wall run. It enters through the LINIER top cable access, comes down the rear of the cabinet, and plugs into the Cat6 pass-through coupler in slot 20. Use an installation-appropriate cable with an RJ45 end at the panel; the cart coupler has no punch-down terminals. Nothing on the front of the panel is ever cut; you only move patch cords.'},
 ...
 {id:'P4',multi:[[19,19]],speed:'2.5G',a:'Patch panel · slot 20 (AP drop)',b:'USW Pro Max · port 20 (2.5 GbE PoE++)',len:'0.15 m Etherlighting',why:'The U7 Pro Max access point has a 2.5 GbE uplink and is PoE powered through this port. This replaces the TP-Link radio.'},
