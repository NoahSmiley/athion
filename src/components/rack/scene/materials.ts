...
export function makeMaterials() {
  return {
    steel: new THREE.MeshStandardMaterial({ color: 0x151a22, metalness: 0.65, roughness: 0.36 }),
    ...
    black: new THREE.MeshStandardMaterial({ color: 0x11151b, metalness: 0.5, roughness: 0.4 }),
    ...
    hub: new THREE.MeshStandardMaterial({ color: 0x222b35, metalness: 0.5, roughness: 0.42 }),
    ...
    side: new THREE.MeshStandardMaterial({ color: 0x161c25, metalness: 0.55, roughness: 0.4, side: THREE.DoubleSide }),
    floor: new THREE.ShadowMaterial({ color: 0x02050a, opacity: 0.35 }),
