...
export function Footer() {
  return (
    <footer style={{ maxWidth: 960, margin: "0 auto", padding: "20px 10px", borderTop: "1px solid #333", fontSize: 11, color: "#828282", display: "flex", flexWrap: "wrap", gap: 10, justifyContent: "center" }}>
